...
//				|| checkDiagonal(startField, steps, endField);
		if(checkDiagonal(startField, steps, endField))
			return true; 
		else if(checkHorizontal(startField, steps, endField))
			return true; 
		else if(checkVertical(startField, steps, endField))
			return true; 
		else return false;
	}
...
//		return false;
	...
	private Boolean checkDiagonal(String startField, int steps, String endField) {
		...
		if ((sDLinks == eB && (s6Oben == e4 || s6Unten == e4)) 
				|| (sDRechts == eB && (s6Oben == e4 || s6Unten == e4))) {
			return true;
		}
